...
char *voc_names[] = {"bicycle", "bus", "car", "motorbike", "train"};

void train_yolo(char *cfgfile, char *weightfile)
{
    char *train_images = "/home/hzl/Desktop/darknet/scripts/train.txt";
    char *backup_directory = "/home/hzl/Desktop/darknet/backup";
    srand(time(0));
